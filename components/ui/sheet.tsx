...
function SheetContent({
  ...
  return (
    <SheetPortal>
      <SheetOverlay />
      <SheetPrimitive.DialogTitle className="hidden"></SheetPrimitive.DialogTitle>
      <SheetPrimitive.DialogDescription className="hidden"></SheetPrimitive.DialogDescription>
